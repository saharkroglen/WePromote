...
public class Constants {
	...
	public static final String TAG = "WePromote";
	public static final int NOTIFICATION_INVITATION_ID = 9876;
	public static final Object EXTERNAL_APP_DIRECTORY_FULL_PATH = null;
