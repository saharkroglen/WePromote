...
public class SampleActivity extends ActionBarActivity {
    ...
    private final String PENDING_ACTION_BUNDLE_KEY = "com.wepromote.hellofacebook:PendingAction";
...
//            	postPhotoWithLink();
    ...
    private void postPhotoWithLink()
    {
		FacebookDialog.ShareDialogBuilder builder = new FacebookDialog.ShareDialogBuilder(
				this)
				.setLink("http://itripy.com/wepromote/campaigns/?cid=yuLKGkmaAU#/")
				.setName("Great Deals Find You !")
				.setPicture("http://bab-images.s3.amazonaws.com/myTrip_photo.jpg");
//				.setFragment(this);
		// share the app
    ...
    private void postPhoto() {
        Bitmap image = BitmapFactory.decodeResource(this.getResources(), R.drawable.abc_ab_bottom_transparent_dark_holo);
    ...
    private void showPickerFragment(PickerFragment<?> fragment) {
        fragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
            ...
            public void onError(PickerFragment<?> pickerFragment, FacebookException error) {
                ...
                Toast toast = Toast.makeText(SampleActivity.this, text, Toast.LENGTH_SHORT);
                toast.show();
            }
        });
